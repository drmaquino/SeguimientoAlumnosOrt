...
public class DBHelper extends SQLiteOpenHelper
{
    ...
    public void addCurso(Curso curso)
    {
        ...
        if (cursoCreado != null)
        {
            ...
            {
                Grupo grupo = new Grupo(id_curso, String.valueOf(i));
                addGrupo(grupo);
            }
        }
    ...
    public void addGrupo(Grupo grupo)
    {
        ...
        Grupo grupoCreado = findGrupoByIdCursoNumero(grupo.get_id_curso(), grupo.get_numero());
    ...
    public Grupo findGrupoByIdCursoNumero(int id_curso, String numero)
    {
        SQLiteDatabase db = this.getReadableDatabase();
        Grupo grupo = null;

        String[] select = new String[] { KEY_ID, KEY_ID_CURSO, KEY_NUMERO };
        String where = String.format("%s=? AND %s=?", KEY_ID_CURSO, KEY_NUMERO);
        String[] whereArgs = new String[] { String.valueOf(id_curso), numero };
