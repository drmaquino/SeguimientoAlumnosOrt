...
public class GruposActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tvCurso.setText(String.format("%s, %s, %s", datosDelCurso[0], datosDelCurso[1], datosDelCurso[2]));
        
        String[] grupos = new String[]{"Grupo 1", "Grupo 2", "Grupo 3", "Grupo 4", "Grupo 5", "Grupo 6", "Grupo 7"};
